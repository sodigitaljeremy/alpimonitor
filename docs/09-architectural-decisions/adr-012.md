...
**Date** : 2026-06-04
**Statut** : Proposée — cadrage (implémentation à venir sur `feat/ai-layer`, aucun code écrit à ce stade)
**Implémentation** : à venir. Cet ADR cadre la couche avant tout code, conformément à la règle d'engagement « lire/cadrer avant d'agir ». Les hashes seront ajoutés au fil des extensions livrées.
