...
**Date** : 2026-06-04
**Statut** : Acceptée — **extension A (narration) livrée** sur `feat/ai-layer` ; extensions **D, B, C proposées** (non implémentées).
...
**D, B, C** restent au statut **proposé** : leurs hashes seront ajoutés quand elles seront livrées. L'« hexagonal » réel (frontière `QueryPort`/`PrismaQueryAdapter`) arrive avec **C** uniquement.
