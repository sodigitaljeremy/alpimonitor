...
On utilise **Prisma** comme ORM et générateur de migrations (Prisma 5 à la décision initiale du 2026-04-18 ; bumpé en **Prisma 6.19** depuis — l'API et le schéma déclaratif restent inchangés).
